                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('ShippingReport') }}">Shipping Analysis</a></li>
                        </ol>
                    </nav>
                </div>
            </li>
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Shipping Analysis Result</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing" id="result" style="display: none">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Shipping Analysis Detail</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content-area">
        ...
        <div class="col-lg-6 layout-spacing layout-spacing" id="result2" style="display: none">
            <div class="statbox widget box box-shadow chartContainer2">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4 class="m-0">Shipping Analysis by Mill</h4>
                            <p style="padding: 0px 15px; font-size: 11px; font-style: italic;">Weight in Ton</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6 layout-spacing layout-spacing" id="result3" style="display: none">
            <div class="statbox widget box box-shadow chartContainer3">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4 class="m-0">Shipping Analysis by Cust</h4>
                            <p style="padding: 0px 15px; font-size: 11px; font-style: italic;">Weight in Ton</p>
                        </div>
                    </div>
                </div>
...
var title1, label1, dp1_1, dp1_2, container1, note;
var title2, label2, dp2, container2;
var title3, label3, dp3, container3;
var txtMill, txtStartDate, txtEndDate
...
function getChart1(title1, label1, dp1_1, dp1_2, container1){
    ...
    chart1.options.data[0].dataPoints = dp1_1;
    chart1.options.data[1].dataPoints = dp1_2;
...
function getPieChart(title2, label2, dp2, container2, note){
    ...
    pie_chart.options.data[0].dataPoints = dp2;
...
function onClick(e){
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('chartShippingReportbyMill') }}",
        data: {
            '_token': '{{ csrf_token() }}',
            'txtMill': txtMill,
        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    dp2.push({  label: data[i].mill_id,  y: Math.round(data[i].wgt_ship)})
                }

                label2 = label1;
                title2 = 'Date Period '+txtPeriode;
                container2 = 'chartContainer2';
                note = "ton";
                getPieChart(title2, label2, dp2, container2, note)
                block2.unblock();
                ...
                swal("Whops", "Detail by Mill N/A",  "error");
                dp2 = [];
                dp2.push({ y: 0 });
                label2 = label1;
                title2 = 'Date Period '+txtPeriode;
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('chartShippingReportbyCust') }}",
        data: {
            '_token': '{{ csrf_token() }}',
            'txtMill': txtMill,
            'txtPeriode': txtPeriode
        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                dp3 = [];
                for (var i = 0; i < data.length; i++) {
                    dp3.push({  label: data[i].NamaCustomer,  y: Math.round(data[i].wgt_ship)})
                }

                label3 = label1;
                title3 = 'Date Period '+txtPeriode;
                container3 = 'chartContainer3';
                note = "ton";
                getPieChart(title3, label3, dp3, container3, note)
                block3.unblock();
                ...
                swal("Whops", "Detail by Cust N/A",  "error");
                dp3 = [];
                dp3.push({ y: 0 });
...
$(document).ready(function() {
    ...
    $('#ShippingReport').addClass('active');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        dp1_1 = []; dp1_2 = [];
                        for (var i = 0; i < data.length; i++) {
                            dp1_1.push({  label: data[i].periode,  y: Math.round(data[i].wgt_ship) });
                            dp1_2.push({  label: data[i].periode,  y: parseFloat(data[i].count_deliv) });
                        }
                        ...
                        getChart1(title1 , label1, dp1_1, dp1_2, container1);
